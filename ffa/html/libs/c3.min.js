!(function (a) {
    ...
    b.loadConfig(a),
      ...
      (function d(a, b, c) {
        Object.keys(a).forEach(function (e) {
          (b[e] = a[e].bind(c)),
            Object.keys(a[e]).length > 0 && d(a[e], b[e], c);
        });
      })(e, this, this);
  }
  function c(b) {
      ...
      j.each(function () {
        ...
        var u,
          ...
          C = B.enter()
            ...
            .style("opacity", 1e-6),
          D = B.exit().remove(),
          E = a.transition(B).style("opacity", 1),
          F = o.rangeExtent ? o.rangeExtent() : e(o.range()),
          G = x.selectAll(".domain").data([0]),
          H =
            (G.enter().append("path").attr("class", "domain"), a.transition(G));
        ...
        switch (
          ((M = B.select("text")),
          (N = M.selectAll("tspan").data(function (a, c) {
          ...
          N.enter().append("tspan"),
          N.exit().remove(),
          /*N.text(function (a) {
            if (a.splitted < 10) {
              return "0" + a.splitted + ":00";
            } else {
              return a.splitted + ":00";
            }
          }),*/
          N.text(function (a) {
            return a.splitted;
          ...
          case "bottom":
            (u = c),
              I.attr("y2", q),
              K.attr("y", Q),
              J.attr("x1", v).attr("x2", v).attr("y2", m),
              L.attr("x", 0).attr("y", Q),
              M.style("text-anchor", "middle"),
              N.attr("x", 0).attr("dy", l),
              H.attr("d", "M" + F[0] + "," + k + "V0H" + F[1] + "V" + k);
            break;
          case "top":
            (u = c),
              I.attr("y2", -q),
              K.attr("y", -Q),
              J.attr("x2", 0).attr("y2", -q),
              L.attr("x", 0).attr("y", -Q),
              M.style("text-anchor", "middle"),
              N.attr("x", 0).attr("dy", "0em"),
              H.attr("d", "M" + F[0] + "," + -k + "V0H" + F[1] + "V" + -k);
            break;
          case "left":
            (u = d),
              I.attr("x2", -q),
              K.attr("x", -Q),
              J.attr("x2", -q).attr("y1", w).attr("y2", w),
              L.attr("x", -Q).attr("y", t),
              M.style("text-anchor", "end"),
              N.attr("x", -Q).attr("dy", l),
              H.attr("d", "M" + -k + "," + F[0] + "H0V" + F[1] + "H" + -k);
            break;
          case "right":
            (u = d),
              I.attr("x2", q),
              K.attr("x", Q),
              J.attr("x2", q).attr("y2", 0),
              L.attr("x", Q).attr("y", 0),
              M.style("text-anchor", "start"),
              N.attr("x", Q).attr("dy", l),
              H.attr("d", "M" + k + "," + F[0] + "H0V" + F[1] + "H" + k);
        }
        if (z.rangeBand) {
  ...
  (g.generate = function (a) {
    ...
    (g.chart = { fn: b.prototype, internal: { fn: c.prototype } }),
    (e = g.chart.fn),
    (f = g.chart.internal.fn),
    (f.init = function () {
      var a = this,
        b = a.config;
    ...
    (f.initWithData = function (b) {
      ...
      e.initPie && e.initPie(),
        ...
        (e.selectChart =
          "function" == typeof g.bindto.node ? g.bindto : f.select(g.bindto)),
        e.selectChart.empty() &&
          ((e.selectChart = f
        ...
        g.data_filter &&
          (e.data.targets = e.data.targets.filter(g.data_filter)),
        g.data_hide &&
          e.addHiddenTargetIds(
            g.data_hide === !0 ? e.mapToIds(e.data.targets) : g.data_hide
          ),
        g.legend_hide &&
          e.addHiddenLegendIds(
            g.legend_hide === !0 ? e.mapToIds(e.data.targets) : g.legend_hide
          ),
        e.hasType("gauge") && (g.legend_show = !1),
        e.updateSizes(),
        e.updateScales(),
        e.x.domain(f.extent(e.getXDomain(e.data.targets))),
        ...
        g.zoom_enabled && e.zoom.scale(e.x),
        (e.svg = e.selectChart
          .append("svg")
        ...
        e.initRegion(),
        e.initGrid(),
        d.append("g").attr("clip-path", e.clipPath).attr("class", i.chart),
        g.grid_lines_front && e.initGridLines(),
        e.initEventRect(),
        e.initChartElements(),
        d
          .insert("rect", g.zoom_privileged ? null : "g." + i.regions)
          .attr("class", i.zoomRect)
          .attr("width", e.width)
          .attr("height", e.height)
          .style("opacity", 0)
          .on("dblclick.zoom", null),
        g.axis_x_extent && e.brush.extent(e.getDefaultExtent()),
        e.initAxis(),
    ...
    (f.redraw = function (a, b) {
      ...
      if (
        ((a = a || {}),
        (c = t(a, "withY", !0)),
        (d = t(a, "withSubchart", !0)),
        (e = t(a, "withTransition", !0)),
        (h = t(a, "withTransform", !1)),
        (j = t(a, "withUpdateXDomain", !1)),
        (k = t(a, "withUpdateOrgXDomain", !1)),
        (l = t(a, "withTrimXDomain", !0)),
        (p = t(a, "withUpdateXAxis", j)),
        (m = t(a, "withLegend", !1)),
        (n = t(a, "withEventRect", !0)),
        (o = t(a, "withDimension", !0)),
        (f = t(a, "withTransitionForExit", e)),
        (g = t(a, "withTransitionForAxis", e)),
        (w = e ? K.transition_duration : 0),
        (x = f ? w : 0),
        (y = g ? w : 0),
        (b = b || H.generateAxisTransitions(y)),
        m && K.legend_show
        ...
        P.length
          ? (H.updateXDomain(P, j, k, l),
            K.axis_x_tick_values || (B = H.updateXAxisTickValues(P)))
        ...
        !K.axis_y_tick_values &&
          K.axis_y_tick_count &&
          H.yAxis.tickValues(
            H.generateTickValues(H.y.domain(), K.axis_y_tick_count)
          ),
        !K.axis_y2_tick_values &&
          K.axis_y2_tick_count &&
          H.y2Axis.tickValues(
            H.generateTickValues(H.y2.domain(), K.axis_y2_tick_count)
          ),
        H.redrawAxis(b, O),
        H.updateAxisLabels(e),
        (j || p) && P.length)
      )
      ...
      (q = H.generateDrawArea ? H.generateDrawArea(L, !1) : void 0),
        ...
        H.redrawArc && H.redrawArc(w, x, h),
        H.redrawSubchart && H.redrawSubchart(d, b, w, x, L, M, N),
        I.selectAll("." + i.selectedCircles)
    ...
    (f.updateAndRedraw = function (a) {
      var b,
        ...
        d = c.config;
      (a = a || {}),
        (a.withTransition = t(a, "withTransition", !0)),
        (a.withTransform = t(a, "withTransform", !1)),
        (a.withLegend = t(a, "withLegend", !1)),
        (a.withUpdateXDomain = !0),
        (a.withUpdateOrgXDomain = !0),
        (a.withTransitionForExit = !1),
        (a.withTransitionForTransform = t(
          a,
    ...
    (f.getTranslate = function (a) {
      ...
      return (
        "main" === a
          ? ((b = p(d.margin.left)), (c = p(d.margin.top)))
          : "context" === a
          ? ((b = p(d.margin2.left)), (c = p(d.margin2.top)))
          : "legend" === a
    ...
    (f.opacityForCircle = function (a) {
      ...
      return j(a.value) ? (this.isScatterType(a) ? 0.5 : b) : 0;
    }),
    ...
    (f.transformMain = function (a, b) {
      ...
      b && b.axisX
        ? (c = b.axisX)
        : ((c = f.main.select("." + i.axisX)), a && (c = c.transition())),
        b && b.axisY
          ? (d = b.axisY)
          : ((d = f.main.select("." + i.axisY)), a && (d = d.transition())),
        b && b.axisY2
          ? (e = b.axisY2)
          : ((e = f.main.select("." + i.axisY2)), a && (e = e.transition())),
        ...
        d = new MutationObserver(function (e) {
          e.forEach(function (e) {
            "childList" === e.type &&
              e.previousSibling &&
              (d.disconnect(),
              (c.intervalForObserveInserted = a.setInterval(function () {
                b.node().parentNode &&
                  (a.clearInterval(c.intervalForObserveInserted),
                  c.updateDimension(),
                  c.config.oninit.call(c),
                  c.redraw({
                    withTransform: !0,
                    withUpdateXDomain: !0,
                    withUpdateOrgXDomain: !0,
      ...
      return (
        (c =
          b instanceof Date
            ...
            ? d.dataTimeFormat(d.config.data_xFormat).parse(b)
            : new Date(+b)),
        (!c || isNaN(+c)) &&
    ...
    (f.updateScales = function () {
      ...
      (a.xMin = b.axis_rotated ? 1 : 0),
        ...
        (a.xAxisTickFormat = a.getXAxisTickFormat()),
        (a.xAxisTickValues = a.getXAxisTickValues()),
        (a.yAxisTickValues = a.getYAxisTickValues()),
        (a.y2AxisTickValues = a.getY2AxisTickValues()),
        (a.xAxis = a.getXAxis(
          a.x,
          a.xOrient,
          a.xAxisTickFormat,
    ...
    (f.getYDomain = function (a, b, c) {
      var d,
        ...
        u = c ? p.filterByXDomain(t, c) : t,
        v = "y2" === b ? r.axis_y2_min : r.axis_y_min,
        w = "y2" === b ? r.axis_y2_max : r.axis_y_max,
        x = p.getYDomainMin(u),
        y = p.getYDomainMax(u),
        z = "y2" === b ? r.axis_y2_center : r.axis_y_center,
        A =
          (p.hasType("bar", u) && r.bar_zerobased) ||
          (p.hasType("area", u) && r.area_zerobased),
        B = "y2" === b ? r.axis_y2_inverted : r.axis_y_inverted,
        C = p.hasDataLabel() && r.axis_rotated,
        D = p.hasDataLabel() && !r.axis_rotated;
      return (
        (x = j(v) ? v : j(w) ? (w > x ? x : w - 10) : x),
        (y = j(w) ? w : j(v) ? (y > v ? y : v + 10) : y),
        0 === u.length
          ? "y2" === b
            ? p.y2.domain()
            : p.y.domain()
          : (isNaN(x) && (x = 0),
            ...
            "undefined" != typeof z &&
              ...
              (x = z - i)),
            C
              ? ((k = p.getDataLabelLength(x, y, "width")),
                (l = q(p.y.range())),
                (m = [k[0] / l, k[1] / l]),
                (g += e * (m[1] / (1 - m[0] - m[1]))),
                (h += e * (m[0] / (1 - m[0] - m[1]))))
              : D &&
                ((k = p.getDataLabelLength(x, y, "height")),
                (g += this.convertPixelsToAxisPadding(k[1], e)),
                (h += this.convertPixelsToAxisPadding(k[0], e))),
            "y" === b &&
              s(r.axis_y_padding) &&
              ((g = p.getAxisPadding(r.axis_y_padding, "top", g, e)),
              (h = p.getAxisPadding(r.axis_y_padding, "bottom", h, e))),
            "y2" === b &&
              s(r.axis_y2_padding) &&
              ((g = p.getAxisPadding(r.axis_y2_padding, "top", g, e)),
              (h = p.getAxisPadding(r.axis_y2_padding, "bottom", h, e))),
            A && (n && (h = x), o && (g = -y)),
            (d = [x - h, y + g]),
            B ? d.reverse() : d)
      );
    ...
    (f.getXDomainPadding = function (a) {
      ...
      return (
        f.isCategorized()
          ...
          : (c = 0.01 * h),
        "object" == typeof g.axis_x_padding && s(g.axis_x_padding)
          ? ((d = j(g.axis_x_padding.left) ? g.axis_x_padding.left : c),
            (e = j(g.axis_x_padding.right) ? g.axis_x_padding.right : c))
          : (d = e =
    ...
    (f.getXValue = function (a, b) {
      var c = this;
      return a in c.data.xs && c.data.xs[a] && j(c.data.xs[a][b])
        ? c.data.xs[a][b]
        : b;
    }),
    ...
    (f.orderTargets = function (a) {
      ...
      return (
        d || e
          ...
          : k(c.data_order) && a.sort(c.data_order),
        a
      );
    }),
    ...
    (f.hasDataLabel = function () {
      ...
      return "boolean" == typeof a.data_labels && a.data_labels
        ? !0
        : "object" == typeof a.data_labels && s(a.data_labels)
        ? !0
        : !1;
    }),
    ...
    (f.convertJsonToData = function (a, b) {
      ...
      return (
        b
          ? ((c = b.value),
            b.x && (c.push(b.x), (e.config.data_x = b.x)),
            f.push(c),
            a.forEach(function (a) {
              var b = [];
            ...
            values: a
              .map(function (a, g) {
                ...
                return (
                  ...
                  (m(a[b]) || d.data.xs[b].length <= g) && (j = void 0),
                  {
                    x: j,
            ...
            void a.forEach(function (a) {
              (c.withoutFadeIn[a] = !1),
                c.legend &&
                  c.legend
                    .selectAll(
                      "." + i.legendItem + c.getTargetSelectorSuffix(a)
                    )
                    .remove(),
    ...
    (f.redrawEventRect = function () {
      var a,
        ...
        f = c.main
          ...
          .classed(i.eventRectsMultiple, e)
          .classed(i.eventRectsSingle, !e);
      f.selectAll("." + i.eventRect).remove(),
        (c.eventRect = f.selectAll("." + i.eventRect)),
        e
      ...
      a.append("rect")
        ...
        .on("mouseover", function (a) {
          ...
          b.dragging ||
            b.flowing ||
            b.hasArcType() ||
            ((c = b.data.targets.map(function (a) {
              return b.addName(b.getValueOnIndex(a.values, f));
            })),
            (e = []),
            Object.keys(d.data_names).forEach(function (a) {
            ...
            (c = e.concat(c)),
            d.point_focus_expand_enabled && b.expandCircles(f, null, !0),
            b.expandBars(f, null, !0),
            b.main.selectAll("." + i.shape + "-" + f).each(function (a) {
        ...
        .on("mouseout", function (a) {
          ...
          b.hasArcType() ||
            ...
            b.unexpandCircles(),
            b.unexpandBars(),
            b.main.selectAll("." + i.shape + "-" + c).each(function (a) {
          ...
          b.dragging ||
            ...
            (!d.tooltip_grouped ||
              ...
              b.main
                .selectAll("." + i.shape + "-" + f)
                .each(function () {
                  c.select(this).classed(i.EXPANDED, !0),
        ...
        .on("click", function (a) {
          ...
          if (!b.hasArcType() && b.toggleShape) {
            ...
            b.isStepType(a) &&
              ...
              (e -= 1),
              b.main.selectAll("." + i.shape + "-" + e).each(function (a) {
    ...
    (f.generateEventRectsForMultipleXs = function (a) {
      function b() {
        c.svg.select("." + i.eventRect).style("cursor", null),
          c.hideXGridFocus(),
          c.hideTooltip(),
          c.unexpandCircles(),
          c.unexpandBars();
      ...
      a.append("rect")
        ...
        .on("mousemove", function () {
          var a,
            ...
            g,
            h,
            j = c.filterTargetsToShow(c.data.targets);
          if (!c.dragging && !c.hasArcType(j)) {
            if (
              ((a = d.mouse(this)),
              (f = c.findClosestFromTargets(j, a)),
              !c.mouseover ||
            ...
            (g =
              ...
              (c.isBarType(f.id) || c.dist(f, a) < 100) &&
                (c.svg.select("." + i.eventRect).style("cursor", "pointer"),
                c.mouseover ||
        ...
        .on("click", function () {
          ...
          c.hasArcType(f) ||
            ...
            b &&
              ...
              c.main
                .selectAll("." + i.shapes + c.getTargetSelectorSuffix(b.id))
                .select("." + i.shape + "-" + b.index)
                .each(function () {
    ...
    (f.dispatchEvent = function (b, c, d) {
      var e = this,
        f = "." + i.eventRect + (e.isMultipleX() ? "" : "-" + c),
        g = e.main.select(f).node(),
        h = g.getBoundingClientRect(),
        j = h.left + (d ? d[0] : 0),
        k = h.top + (d ? d[1] : 0),
        l = document.createEvent("MouseEvents");
      l.initMouseEvent(b, !0, !0, a, 0, j, k, j, k, !1, !1, !1, !1, 0, null),
        g.dispatchEvent(l);
    }),
    ...
    (f.getCurrentPaddingLeft = function (a) {
      var b = this,
        c = b.config;
      return j(c.padding_left)
        ? c.padding_left
        : c.axis_rotated
        ? c.axis_x_show
          ? Math.max(o(b.getAxisWidthByAxisId("x", a)), 40)
          : 1
        : !c.axis_y_show || c.axis_y_inner
        ? b.getYAxisLabelPosition().isOuter
          ? 30
          : 1
        : o(b.getAxisWidthByAxisId("y", a));
    }),
    (f.getCurrentPaddingRight = function () {
      ...
      return j(b.padding_right)
        ? b.padding_right + 1
        : b.axis_rotated
        ? c + d
        : !b.axis_y2_show || b.axis_y2_inner
        ? 2 + d + (a.getY2AxisLabelPosition().isOuter ? 20 : 0)
        : o(a.getAxisWidthByAxisId("y2")) + d;
    }),
    (f.getParentRectValue = function (a) {
      for (
        var b, c = this.selectChart.node();
        c && "BODY" !== c.tagName && !(b = c.getBoundingClientRect()[a]);
        ...
        ? "x" === a && c.axis_x_height
          ...
          ? "y2" !== a || c.axis_y2_show
            ? ("x" === a &&
              ...
              d +
                (b.getAxisLabelPositionById(a).isInner ? 0 : 10) +
                ("y2" === a ? -10 : 0))
    ...
    (f.getEventRectWidth = function () {
      ...
      return h
        ? ((a = h.values[0]),
          (b = h.values[h.values.length - 1]),
          (c = g.x(b.x) - g.x(a.x)),
          0 === c
            ? g.config.axis_rotated
              ? g.height
              : g.width
            : ((d = g.getMaxDataCount()),
              (e = g.hasType("bar")
                ? (d - (g.isCategorized() ? 0.25 : 1)) / d
                : 1),
              (f = d > 1 ? (c * e) / (d - 1) : c),
              1 > f ? 1 : f))
        : 0;
      ...
      return (
        d.isTargetToShow(b.id)
          ? "circle" === a.nodeName
            ...
            : "path" === a.nodeName &&
              (c = e.classed(i.bar) ? d.isWithinBar(a) : !0)
          : (c = !1),
        c
      );
    }),
    ...
    (f.updateTargetsForLine = function (a) {
      ...
      (b = d.main
        ...
        a.forEach(function (a) {
          d.main
            .selectAll(
              "." + i.selectedCircles + d.getTargetSelectorSuffix(a.id)
            )
    ...
    (f.lineWithRegions = function (a, b, c, d) {
      ...
      if (n(d))
        for (f = 0; f < d.length; f++)
          (x[f] = {}),
            (x[f].start = m(d[f].start)
              ? a[0].x
              : t.isTimeSeries()
              ? t.parseDate(d[f].start)
              : d[f].start),
            (x[f].end = m(d[f].end)
              ? a[a.length - 1].x
              : t.isTimeSeries()
      ...
      for (
        ...
        if (m(x) || !e(a[f].x, x)) w += " " + r(a[f]) + " " + s(a[f]);
        else
          for (
            i = t.getScale(a[f - 1].x, a[f].x, t.isTimeSeries()),
              j = t.getScale(a[f - 1].value, a[f].value),
              k = b(a[f].x) - b(a[f - 1].x),
              l = c(a[f].value) - c(a[f - 1].value),
              o = Math.sqrt(Math.pow(k, 2) + Math.pow(l, 2)),
              p = 2 / o,
              q = 2 * p,
              g = p;
            1 >= g;
    ...
    (f.getCircles = function (a, b) {
      ...
      return (
        b
          ? c.main.selectAll("." + i.circles + c.getTargetSelectorSuffix(b))
          : c.main
      ).selectAll("." + i.circle + (j(a) ? "-" + a : ""));
    }),
    (f.expandCircles = function (a, b, c) {
      var d = this,
        e = d.pointExpandedR.bind(d);
      c && d.unexpandCircles(),
        d.getCircles(a, b).classed(i.EXPANDED, !0).attr("r", e);
    }),
      ...
      var c = this,
        ...
        e =
          "number" == typeof d.bar_width
            ? d.bar_width
            : b
            ? (2 * a.tickOffset() * d.bar_width_ratio) / b
            : 0;
    ...
    (f.getBars = function (a, b) {
      ...
      return (
        b
          ? c.main.selectAll("." + i.bars + c.getTargetSelectorSuffix(b))
          : c.main
      ).selectAll("." + i.bar + (j(a) ? "-" + a : ""));
    }),
    ...
    (f.getTextRect = function (a, b) {
      var c,
        d = this.d3.select("body").classed("c3", !0),
        e = d.append("svg").style("visibility", "hidden");
      return (
        e
          .selectAll(".dummy")
          .data([a])
    ...
    (f.getYForText = function (a, b, c) {
      ...
      return (
        (d = e.config.axis_rotated
          ? (a[0][0] + a[2][0] + 0.6 * f.height) / 2
          : a[2][1] + (b.value < 0 ? f.height : e.isBarType(b) ? -3 : -6)),
        null !== b.value ||
    ...
    (f.initGrid = function () {
      ...
      (a.grid = a.main
        ...
        .attr("class", i.grid)),
        b.grid_x_show && a.grid.append("g").attr("class", i.xgrids),
        b.grid_y_show && a.grid.append("g").attr("class", i.ygrids),
        b.grid_focus_show &&
          a.grid
            .append("g")
    ...
    (f.initGridLines = function () {
      ...
      (a.gridLines = a.main
        ...
        a.gridLines.append("g").attr("class", i.xgridLines),
    ...
    (f.updateXGrid = function (a) {
      ...
      (b.xgridAttr = c.axis_rotated
        ...
        (b.xgrid = b.main
          ...
          .selectAll("." + i.xgrid)
          .data(e)),
        b.xgrid.enter().append("line").attr("class", i.xgrid),
        a ||
    ...
    (f.updateYGrid = function () {
      ...
      (a.ygrid = a.main
        ...
        .selectAll("." + i.ygrid)
        .data(c)),
        a.ygrid.enter().append("line").attr("class", i.ygrid),
        a.ygrid
    ...
    (f.updateGrid = function (a) {
      ...
      e.grid.style("visibility", e.hasArcType() ? "hidden" : "visible"),
        f.select("line." + i.xgridFocus).style("visibility", "hidden"),
        ...
        c
          ...
          .attr("text-anchor", "end")
          .attr("transform", g.axis_rotated ? "rotate(-90)" : "")
          .attr("dx", g.axis_rotated ? 0 : -e.margin.top)
          .attr("dy", -5)
          .style("opacity", 0),
        (d = e.yv.bind(e)),
        e.ygridLines
        ...
        e.ygridLines
          ...
          .transition()
          .duration(a)
          .attr("x", g.axis_rotated ? 0 : e.width)
          .attr("y", d)
          .text(function (a) {
            return a.text;
          })
    ...
    (f.showXGridFocus = function (a) {
      var b = this,
        ...
        e = b.main.selectAll("line." + i.xgridFocus),
        f = b.xx.bind(b);
      c.tooltip_show &&
        (b.hasType("scatter") ||
          b.hasArcType() ||
    ...
    (f.removeGridLines = function (a, b) {
      var c = this,
        ...
        g = b ? i.xgridLines : i.ygridLines,
        h = b ? i.xgridLine : i.ygridLine;
      c.main
        .select("." + g)
        .selectAll("." + h)
        .filter(e)
    ...
    (f.getTooltipContent = function (a, b, c, d) {
      ...
      for (f = 0; f < a.length; f++)
        a[f] &&
          ...
          (e ||
            ((g = n ? n(a[f].x) : a[f].x),
            (e = "<table class='" + i.tooltip + "'>")),
          (h = p(a[f].value, a[f].ratio, a[f].id, a[f].index)),
          void 0 !== h &&
            ((j = o(a[f].name, a[f].ratio, a[f].id, a[f].index)),
            (k = l.levelColor ? l.levelColor(a[f].value) : d(a[f].id)),
            (e += "<tr class='" + i.tooltipName + "-" + 1 + "'>"),
    ...
    (f.showTooltip = function (a, b) {
      ...
      0 !== k.length &&
        ...
        (g.tooltip
          .html(
            h.tooltip_contents.call(
              g,
              a,
              g.getXAxisTickFormat(),
              g.getYFormat(i),
              g.color
            )
          )
          .style("display", "block"),
        (c = g.tooltip.property("offsetWidth")),
        (d = g.tooltip.property("offsetHeight")),
        (e = l.call(this, k, c, d, b)),
        g.tooltip.style("top", e.top + "px").style("left", e.left + "px"));
    }),
    ...
    (f.opacityForUnfocusedLegend = function (a) {
      return a.classed(i.legendItemHidden) ? null : 0.3;
    }),
  ...
  (f.clearLegendItemTextBoxCache = function () {
    ...
    (f.updateLegend = function (a, b, c) {
      function d(a, b) {
        return (
          h[b] || (h[b] = w.getTextRect(a.textContent, i.legendItem)), h[b]
        );
      }
      function e(b, c, e) {
        function f(a, b) {
          b ||
            ((g = (o - E - n) / 2), C > g && ((g = (o - n) / 2), (E = 0), K++)),
            (J[a] = K),
            (I[K] = w.isLegendInset ? 10 : g),
            (F[a] = E),
            (E += n);
        }
        var g,
          ...
          j = e === a.length - 1,
          k = d(b, c),
          l = k.width + D + (!j || w.isLegendRight || w.isLegendInset ? z : 0),
          m = k.height + y,
          n = w.isLegendRight || w.isLegendInset ? m : l,
          o =
            w.isLegendRight || w.isLegendInset
              ? w.getLegendHeight()
              : w.getLegendWidth();
        return (
          i && ((E = 0), (K = 0), (A = 0), (B = 0)),
          x.legend_show && !w.isLegendToShow(c)
            ? void (G[c] = H[c] = J[c] = F[c] = 0)
            : ((G[c] = l),
              (H[c] = m),
              (!A || l >= A) && (A = l),
              (!B || m >= B) && (B = m),
              (h = w.isLegendRight || w.isLegendInset ? B : A),
              void (x.legend_equally
      ...
      (b = b || {}),
        (p = t(b, "withTransition", !0)),
        (q = t(b, "withTransitionForTransform", !0)),
        w.isLegendInset &&
          ((K = x.legend_inset_step ? x.legend_inset_step : a.length),
          w.updateLegendStep(K)),
        w.isLegendRight
          ? ((f = function (a) {
              return A * J[a];
            }),
        ...
        (o = w.legend
          ...
          .on("click", function (a) {
            x.legend_item_onclick
              ? x.legend_item_onclick.call(w, a)
              : w.d3.event.altKey
              ? (w.api.hide(), w.api.show(a))
              : (w.api.toggle(a),
                w.isTargetToShow(a) ? w.api.focus(a) : w.api.revert());
          })
          .on("mouseover", function (a) {
            w.d3.select(this).classed(i.legendItemFocused, !0),
              !w.transiting && w.isTargetToShow(a) && w.api.focus(a),
              x.legend_item_onmouseover && x.legend_item_onmouseover.call(w, a);
          })
          .on("mouseout", function (a) {
            w.d3.select(this).classed(i.legendItemFocused, !1),
              w.api.revert(),
              x.legend_item_onmouseout && x.legend_item_onmouseout.call(w, a);
          })),
        o
          .append("text")
          .text(function (a) {
          ...
          .style("pointer-events", "none")
          .attr("x", w.isLegendRight || w.isLegendInset ? g : -200)
          .attr("y", w.isLegendRight || w.isLegendInset ? -200 : l),
        o
          .append("rect")
          .attr("class", i.legendItemEvent)
          .style("fill-opacity", 0)
          .attr("x", w.isLegendRight || w.isLegendInset ? j : -200)
          .attr("y", w.isLegendRight || w.isLegendInset ? -200 : m),
        o
          .append("rect")
          ...
          .style("fill", w.color)
          .attr("x", w.isLegendRight || w.isLegendInset ? g : -200)
          .attr("y", w.isLegendRight || w.isLegendInset ? -200 : k)
          .attr("width", 10)
          .attr("height", 10),
        (v = w.legend.select("." + i.legendBackground + " rect")),
        w.isLegendInset &&
          A > 0 &&
          0 === v.size() &&
          (v = w.legend
        ...
        (p ? r.transition() : r).attr("x", g).attr("y", l),
        (s = w.legend.selectAll("rect." + i.legendItemEvent).data(a)),
        (p ? s.transition() : s)
          ...
          .attr("x", j)
          .attr("y", m),
        (u = w.legend.selectAll("rect." + i.legendItemTile).data(a)),
        (p ? u.transition() : u)
          .style("fill", w.color)
          .attr("x", f)
          .attr("y", k),
        v &&
          (p ? v.transition() : v)
            .attr("height", w.getLegendHeight() - 12)
            .attr("width", A * (K + 1) + 10),
        w.legend
          .selectAll("." + i.legendItem)
          .classed(i.legendItemHidden, function (a) {
          ...
          .style("opacity", function (a) {
            ...
            return w.isTargetToShow(a)
              ? !L || b.classed(i.legendItemFocused)
                ? w.opacityForLegend(b)
                : w.opacityForUnfocusedLegend(b)
              : null;
          }),
        w.updateLegendItemWidth(A),
        w.updateLegendItemHeight(B),
        w.updateLegendStep(K),
        w.updateSizes(),
        w.updateScales(),
        w.updateSvgSize(),
        w.transformAll(q, c),
        (w.legendHasRendered = !0);
    }),
    (f.initAxis = function () {
      var a = this,
        b = a.config,
      ...
      (a.axes.x = c
        ...
        a.axes.x
          ...
          .style("text-anchor", a.textAnchorForXAxisLabel.bind(a)),
        (a.axes.y = c
          .append("g")
        ...
        a.axes.y
          ...
          .attr("transform", b.axis_rotated ? "" : "rotate(-90)")
          .style("text-anchor", a.textAnchorForYAxisLabel.bind(a)),
        (a.axes.y2 = c
          .append("g")
        ...
        a.axes.y2
          ...
          .attr("transform", b.axis_rotated ? "" : "rotate(-90)")
          .style("text-anchor", a.textAnchorForY2AxisLabel.bind(a));
    }),
    (f.getXAxis = function (a, b, c, e, f, g) {
      ...
      return (
        ...
        k.tickFormat(c).tickValues(e),
        h.isCategorized()
          ? (k.tickCentered(i.axis_x_tick_centered),
            r(i.axis_x_tick_culling) && (i.axis_x_tick_culling = !1))
          : (k.tickOffset = function () {
              var a = this.scale(),
                b = h.getEdgeX(h.data.targets),
                c = a(b[1]) - a(b[0]),
    ...
    (f.getYAxis = function (a, b, c, e, f) {
      var g = { withOuterTick: f },
        h = d(this.d3, g).scale(a).orient(b).tickFormat(c);
      return (
        this.isTimeSeriesY()
          ? h.ticks(
              this.d3.time[this.config.axis_y_tick_time_value],
              this.config.axis_y_tick_time_interval
            )
          : h.tickValues(e),
        h
      );
    ...
    (f.getY2AxisTickValues = function () {
      return this.getAxisTickValues(
        this.config.axis_y2_tick_values,
        this.y2Axis
      );
    }),
    ...
    (f.getXAxisLabelPosition = function () {
      return this.getAxisLabelPosition(
        "x",
        this.config.axis_rotated ? "inner-top" : "inner-right"
      );
    }),
    (f.getYAxisLabelPosition = function () {
      return this.getAxisLabelPosition(
        "y",
        this.config.axis_rotated ? "inner-right" : "inner-top"
      );
    }),
    ...
    (f.dyForYAxisLabel = function () {
      ...
      return a.config.axis_rotated
        ...
        : b.isInner
        ? "1.2em"
        : -10 - (a.config.axis_y_inner ? 0 : a.getMaxTickWidth("y") + 10);
    }),
    ...
    (f.textAnchorForXAxisLabel = function () {
      var a = this;
      return a.textAnchorForAxisLabel(
        !a.config.axis_rotated,
        a.getXAxisLabelPosition()
      );
    }),
    ...
    (f.rotateTickText = function (a, b, c) {
      a.selectAll(".tick text").style("text-anchor", c > 0 ? "start" : "end"),
        b
          .selectAll(".tick text")
          .attr("y", this.yForRotatedTickText(c))
          .attr("transform", "rotate(" + c + ")")
          .selectAll("tspan")
          .attr("dx", this.xForRotatedTickText(c));
    }),
    (f.getMaxTickWidth = function (b, c) {
      var d,
        ...
        j = i.config,
        k = 0;
      return c && i.currentMaxTickWidths[b]
        ? i.currentMaxTickWidths[b]
        : (i.svg &&
            ((d = i.filterTargetsToShow(i.data.targets)),
            "y" === b
              ? ((e = i.y.copy().domain(i.getYDomain(d, "y"))),
                (f = i.getYAxis(
                  e,
                  i.yOrient,
                  j.axis_y_tick_format,
                  i.yAxisTickValues
                )))
              : "y2" === b
              ? ((e = i.y2.copy().domain(i.getYDomain(d, "y2"))),
                (f = i.getYAxis(
                  e,
                  i.y2Orient,
                  j.axis_y2_tick_format,
                  i.y2AxisTickValues
                )))
              : ((e = i.x.copy().domain(i.getXDomain(d))),
                (f = i.getXAxis(
                  e,
                  i.xOrient,
                  i.xAxisTickFormat,
                ...
                i.updateXAxisTickValues(d, f)),
            (g = this.d3.select("body").classed("c3", !0)),
            (h = g.append("svg").style("visibility", "hidden")),
            h
              .append("g")
              .call(f)
              .each(function () {
            ...
            g.classed("c3", !1)),
          (i.currentMaxTickWidths[b] = 0 >= k ? i.currentMaxTickWidths[b] : k),
          i.currentMaxTickWidths[b]);
    }),
    (f.updateAxisLabels = function (a) {
      var b = this,
        c = b.main.select("." + i.axisX + " ." + i.axisXLabel),
        d = b.main.select("." + i.axisY + " ." + i.axisYLabel),
        e = b.main.select("." + i.axisY2 + " ." + i.axisY2Label);
      (a ? c.transition() : c)
        .attr("x", b.xForXAxisLabel.bind(b))
        .attr("dx", b.dxForXAxisLabel.bind(b))
        .attr("dy", b.dyForXAxisLabel.bind(b))
        .text(b.textForXAxisLabel.bind(b)),
        (a ? d.transition() : d)
          .attr("x", b.xForYAxisLabel.bind(b))
          .attr("dx", b.dxForYAxisLabel.bind(b))
          .attr("dy", b.dyForYAxisLabel.bind(b))
          .text(b.textForYAxisLabel.bind(b)),
        (a ? e.transition() : e)
          .attr("x", b.xForY2AxisLabel.bind(b))
          .attr("dx", b.dxForY2AxisLabel.bind(b))
          .attr("dy", b.dyForY2AxisLabel.bind(b))
          .text(b.textForY2AxisLabel.bind(b));
    }),
    ...
    (f.generateTickValues = function (a, b, c) {
      var d,
        ...
        l = a;
      if (b)
        if (((d = k(b) ? b() : b), 1 === d)) l = [a[0]];
        else if (2 === d) l = [a[0], a[a.length - 1]];
        else if (d > 2) {
          for (
            g = d - 2,
              e = a[0],
            ...
            (j = +e + h * (i + 1)), l.push(c ? new Date(j) : j);
          l.push(f);
        }
      return (
        c ||
    ...
    (f.redrawAxis = function (a, b) {
      ...
      c.axes.x.style("opacity", b ? 0 : 1),
        ...
        !d.axis_rotated &&
          d.axis_x_tick_rotate &&
          (c.rotateTickText(c.axes.x, a.axisX, d.axis_x_tick_rotate),
          c.rotateTickText(c.axes.subx, a.axisSubX, d.axis_x_tick_rotate));
    }),
    ...
    (f.expandArc = function (b) {
      ...
      return d.transiting
        ...
        : ((b = d.mapToTargetIds(b)),
          void d.svg
            .selectAll(d.selectorTargets(b, "." + i.chartArc))
            .each(function (a) {
    ...
    (f.unexpandArc = function (a) {
      ...
      b.transiting ||
        ...
        b.svg
          .selectAll(b.selectorTargets(a, "." + i.chartArc))
          .selectAll("path")
          .transition()
          .duration(50)
          .attr("d", b.svgArc),
        b.svg.selectAll("." + i.arc).style("opacity", 1));
    }),
    ...
    (f.redrawArc = function (a, b, c) {
      ...
      (d = h
        ...
        e.hasType("gauge") &&
          (e.arcs.select("." + i.chartArcsBackground).attr("d", function () {
            var a = {
    ...
    (f.initGauge = function () {
      var a = this.arcs;
      this.hasType("gauge") &&
        (a.append("path").attr("class", i.chartArcsBackground),
        a
          .append("text")
      ...
      return [
        (a ? c.transition() : c)
          ...
          .style("fill-opacity", function (a) {
            return j(a.opacity) ? a.opacity : 0.1;
          }),
      ];
    }),
    ...
    (f.drag = function (a) {
      ...
      k.hasArcType() ||
        (l.data_selection_enabled &&
          (!l.zoom_enabled || k.zoom.altDomain) &&
          ...
          (f = Math.min(b, d)),
          (g = Math.max(b, d)),
          (h = l.data_selection_grouped ? k.margin.top : Math.min(c, e)),
          ...
          m
            ...
            .each(function (a, b) {
              var c,
                ...
                o,
                p = n.select(this),
                q = p.classed(i.SELECTED),
                r = p.classed(i.INCLUDED),
                s = !1;
              if (p.classed(i.circle))
                ...
                (o = v(this)),
                  ...
                  (l = o.height),
                  (m = k.togglePath),
                  (s = !(c > g || f > c + e || d > j || h > d + l));
              }
              s ^ r &&
                (p.classed(i.INCLUDED, !r),
                p.classed(i.SELECTED, !q),
                m.call(k, !q, p, a, b));
            })));
    }),
      ...
      a.hasArcType() ||
        (b.data_selection_enabled &&
          (a.main
            ...
            .style("opacity", 0)
            .remove(),
          a.main.selectAll("." + i.shape).classed(i.INCLUDED, !1),
          (a.dragging = !1)));
    }),
    (f.selectPoint = function (a, b, c) {
      ...
      e.data_onselected.call(d.api, b, a.node()),
        d.main
          .select("." + i.selectedCircles + d.getTargetSelectorSuffix(b.id))
          .selectAll("." + i.selectedCircle + "-" + c)
          .data([b])
          .enter()
          .append("circle")
          .attr("class", function () {
    ...
    (f.updateTargetsForSubchart = function (a) {
      ...
      h.subchart_show &&
        ((e = g
          ...
          .data(a)
          .attr("class", j)),
        (d = e.enter().append("g").style("opacity", 0).attr("class", j)),
        d.append("g").attr("class", k),
        (c = g
          .select("." + i.chartLines)
          .selectAll("." + i.chartLine)
          .data(a)
          .attr("class", l)),
        (b = c.enter().append("g").style("opacity", 0).attr("class", l)),
    ...
    (f.transformContext = function (a, b) {
      ...
      b && b.axisSubX
        ? (c = b.axisSubX)
        : ((c = d.context.select("." + i.axisX)), a && (c = c.transition())),
    ...
    (f.initZoom = function () {
      ...
      (b.zoom = c.behavior
        ...
        (b.zoom.updateScaleExtent = function () {
          var a = q(b.x.orgDomain()) / q(b.orgXDomain),
    ...
    (f.generateColor = function () {
      var a = this,
        ...
        c = a.d3,
        d = b.data_colors,
        e = s(b.color_pattern) ? b.color_pattern : c.scale.category10().range(),
        f = b.data_color,
        g = [];
      return function (a) {
        var b,
  ...
  (f.generateClass = function (a, b) {
    ...
    (f.classRegion = function (a, b) {
      return (
        this.generateClass(i.region, b) + " " + ("class" in a ? a["class"] : "")
      );
    }),
    ...
    (f.classTarget = function (a) {
      var b = this,
        ...
        d = "";
      return (
        c && (d = " " + i.target + "-" + c), b.generateClass(i.target, a) + d
      );
    }),
    ...
    (f.classDefocused = function (a) {
      return (
        " " + (this.defocusedTargetIds.indexOf(a.id) >= 0 ? i.defocused : "")
      );
    }),
  ...
  (e.focus = function (a) {
    ...
    (a = c.mapToTargetIds(a)),
      ...
      this.revert(),
      this.defocus(),
      b.classed(i.focused, !0).classed(i.defocused, !1),
    ...
    (e.defocus = function (a) {
      ...
      (a = c.mapToTargetIds(a)),
        (b = c.svg.selectAll(c.selectorTargets(a.filter(c.isTargetToShow, c)))),
        this.revert(),
        b.classed(i.focused, !1).classed(i.defocused, !0),
    ...
    (e.revert = function (a) {
      ...
      (a = c.mapToTargetIds(a)),
        ...
        b.classed(i.focused, !1).classed(i.defocused, !1),
        c.hasArcType() && c.unexpandArc(a),
      ...
      (b = k.convertDataToTargets(c, !0)),
              ...
              for (
                e = !0,
                  a.values[a.values.length - 1] &&
                    (p = a.values[a.values.length - 1].index + 1),
                  o = b[c].values.length,
                  d = 0;
                o > d;
                d++
              )
                (b[c].values[d].index = p + d),
                  k.isTimeSeries() || (b[c].values[d].x = p + d);
        ...
        k.data.targets.forEach(function (a) {
          ...
          for (b = 0; b < l.length; b++)
            if (a.id === l[b])
              for (
                p = a.values[a.values.length - 1].index + 1, c = 0;
                o > c;
                c++
              )
                a.values.push({
        ...
        k.data.targets.length &&
          b.forEach(function (a) {
            var b,
              c = [];
            for (b = k.data.targets[0].values[0].index; p > b; b++)
              c.push({
                id: a.id,
                index: b,
        ...
        (k.data.targets = k.data.targets.concat(b)),
        (d = k.getMaxDataCount()),
        (f = k.data.targets[0]),
        (g = f.values[0]),
        n(a.to)
          ? ((o = 0),
            (i = k.isTimeSeries() ? k.parseDate(a.to) : a.to),
        ...
        m
          ? 1 === m &&
            ...
            k.updateXDomain(null, !0, !0, !1, e))
          : ((h = k.isTimeSeries()
              ? f.values.length > 1
                ? f.values[f.values.length - 1].x - g.x
                : g.x - k.getXDomain(k.data.targets)[0]
              : 1),
            (e = [g.x - h, g.x]),
            k.updateXDomain(null, !0, !0, !1, e)),
        k.updateTargets(k.data.targets),
        k.redraw({
          flow: {
            index: g.index,
            length: o,
            ...
            .call(C, function () {
              ...
              if (w) {
                ...
                b.svg
                  ...
                  b.svg
                    ...
                    .remove(),
                  b.svg
                    .selectAll("." + i.eventRects)
                    .selectAll(f)
                    .remove(),
                  b.svg.select("." + i.xgrid).remove();
              }
              D.attr("transform", null).attr(b.xgridAttr),
                ...
                E.select("text")
                  .attr("x", c.axis_rotated ? b.width : 0)
                  .attr("y", p),
                H.attr("transform", null).attr("d", k),
    ...
    (e.selected = function (a) {
      ...
      return c.merge(
        b.main
          .selectAll("." + i.shapes + b.getTargetSelectorSuffix(a))
          .selectAll("." + i.shape)
          .filter(function () {
        ...
        d.main
          ...
          .each(function (g, h) {
            var j = e.select(this),
              ...
              l = d.getToggle(this, g).bind(d),
              m = f.data_selection_grouped || !a || a.indexOf(k) >= 0,
              o = !b || b.indexOf(h) >= 0,
            ...
            j.classed(i.line) ||
              ...
              (m && o
                ? f.data_selection_isselectable(g) &&
                  !p &&
                  l(!0, j.classed(i.SELECTED, !0), g, h)
                : n(c) && c && p && l(!1, j.classed(i.SELECTED, !1), g, h));
          });
    }),
          ...
          .each(function (f, g) {
            ...
            h.classed(i.line) ||
              ...
              (l &&
                ...
                n &&
                k(!1, h.classed(i.SELECTED, !1), f, g));
          });
    }),
    ...
    (e.regions.remove = function (a) {
      ...
      return (
        ...
        (c = e.getOption(a, "classes", [i.region])),
        (d = e.main.select("." + i.regions).selectAll(
          c.map(function (a) {
            return "." + a;
          })
        )),
    ...
    (e.axis.max = function (a) {
      ...
      return arguments.length
        ? ("object" == typeof a
            ? (j(a.x) && (c.axis_x_max = a.x),
              j(a.y) && (c.axis_y_max = a.y),
              j(a.y2) && (c.axis_y2_max = a.y2))
    ...
    (e.axis.min = function (a) {
      ...
      return arguments.length
        ? ("object" == typeof a
            ? (j(a.x) && (c.axis_x_min = a.x),
              j(a.y) && (c.axis_y_min = a.y),
              j(a.y2) && (c.axis_y2_min = a.y2))
    ...
    (e.axis.range = function (a) {
      return arguments.length
        ? (n(a.max) && this.axis.max(a.max),
          void (n(a.min) && this.axis.min(a.min)))
        ...
        a.data
          ? d.isMultipleX()
            ? ((c = [d.x(a.data.x), d.getYScale(a.data.id)(a.data.value)]),
              (b = null))
            : (b = j(a.data.index) ? a.data.index : d.getIndexByX(a.data.x))
