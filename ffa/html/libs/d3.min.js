!(function () {
  ...
  function w(n) {
    for (var t = new M(), e = 0, r = arguments.length; ++e < r; )
      t[arguments[e]] = x(t);
    return (
      (t.of = function (e, r) {
        return function (u) {
  ...
  function L(n) {
    ...
    return function (e, r) {
      ...
      r
        ? ((t.lastIndex = 0),
          t.test(u) || e.setAttribute("class", N(u + " " + n)))
        : e.setAttribute("class", N(u.replace(t, " ")));
    };
  }
  function T(n, t, e) {
    function r() {
  ...
  function ct(n, t, e) {
    return this instanceof ct
      ...
      ? n instanceof ct
        ...
        : n instanceof st
        ? ht(n.l, n.a, n.b)
        : ht((n = _t((n = ta.rgb(n)).r, n.g, n.b)).l, n.a, n.b)
      : new ct(n, t, e);
  }
  function lt(n, t, e) {
    return (
  ...
  function ht(n, t, e) {
    return n > 0
      ? new ct(Math.atan2(e, t) * Ha, Math.sqrt(t * t + e * e), n)
      : new ct(0 / 0, 0 / 0, n);
  }
  function gt(n) {
  ...
  function _t(n, t, e) {
    ...
    var r = pt((0.4124564 * n + 0.3575761 * t + 0.1804375 * e) / Ja),
      u = pt((0.2126729 * n + 0.7151522 * t + 0.072175 * e) / Ga),
      i = pt((0.0193339 * n + 0.119192 * t + 0.9503041 * e) / Ka);
  ...
  function qt() {
    var n = Lt(),
      t = Tt() - n;
    t > 24
      ? (isFinite(t) && (clearTimeout(ic), (ic = setTimeout(qt, t))), (uc = 0))
      : ((uc = 1), ac(qt));
  }
  function Lt() {
    var n = Date.now();
    ...
    function t(n) {
      function t(t) {
        for (var e, u, i, o = [], a = -1, c = 0; ++a < r; )
          37 === n.charCodeAt(a) &&
            (o.push(n.slice(c, a)),
            null != (u = pc[(e = n.charAt(++a))]) && (e = n.charAt(++a)),
  ...
  function De(n, t) {
    return (
      ((n = n.x)[0] < 0 ? n[1] - ja - Ta : ja - n[1]) -
      ((t = t.x)[0] < 0 ? t[1] - ja - Ta : ja - t[1])
    );
  }
  function Pe(n) {
    var t,
      ...
      if (s)
        for (
          ...
          var m = n[0],
            ...
            k = p * M;
          if (
            (_c.add(Math.atan2(k * _ * Math.sin(w), v * x + k * Math.cos(w))),
            (i += S ? b + _ * Pa : b),
            S ^ (h >= e) ^ (m >= e))
          ) {
            var E = de(pe(f), pe(n));
  ...
  function Ye(n, t, e, r) {
    ...
    return function (a) {
      ...
      function p(n, t) {
        (n = Math.max(-Uc, Math.min(Uc, n))),
          (t = Math.max(-Uc, Math.min(Uc, t)));
        var e = s(n, t);
        if ((d && m.push([n, t]), S))
          (y = n),
            (M = t),
  ...
  function ir(n) {
    ...
    return (
      ...
      (t.clipAngle = function (n) {
        return arguments.length
          ? ((x = null == n ? ((_ = n), Pc) : He((_ = +n) * Fa)), u())
          : _;
      }),
      (t.clipExtent = function (n) {
        return arguments.length
          ? ((w = n),
            (b = n ? Ye(n[0][0], n[0][1], n[1][0], n[1][1]) : Et),
            u())
          : w;
      }),
      (t.scale = function (n) {
    ...
    var u = Math.cos(t),
      ...
      p = h
        ? function (n) {
            ...
            return [
              Math.atan2(u, r) * Ha,
              Math.atan2(o, Math.sqrt(r * r + u * u)) * Ha,
            ];
          }
        : function () {
            return [n * Ha, t * Ha];
  ...
  function _r(n, t) {
    ...
    return i
      ? ((e.invert = function (n, t) {
          ...
          return [
            Math.atan2(n, e) / i,
            2 * Math.atan(Math.pow(o / r, 1 / i)) - ja,
          ];
        }),
        e)
      : Sr;
  ...
  function Ur(n) {
    ...
    for (
      var c = i;
      c.circle && va(e - c.circle.x) < Ta && va(r - c.circle.cy) < Ta;
    ...
    for (
      var l = o;
      l.circle && va(e - l.circle.x) < Ta && va(r - l.circle.cy) < Ta;
  ...
  function Xr(n) {
    var t = n.circle;
    t &&
      (t.P || (ul = t.N), il.remove(t), al.push(t), tu(t), (n.circle = null));
  }
  function $r(n) {
    for (
      var t, e = tl, r = Oe(n[0][0], n[0][1], n[1][0], n[1][1]), u = e.length;
      u--;
      ...
      (t = e[u]),
        (!Br(t, n) ||
          !r(t) ||
          (va(t.a.x - t.b.x) < Ta && va(t.a.y - t.b.y) < Ta)) &&
  ...
  function Jr(n, t, e, r) {
    ...
    return (
      ...
      e && Kr(u, n, t, e),
      r && Kr(u, t, n, r),
      el[n.i].edges.push(new Qr(u, n, t)),
      el[t.i].edges.push(new Qr(u, t, n)),
      u
    );
  }
  function Gr(n, t, e) {
  ...
  function iu(n, t) {
    ...
    for (tl = [], el = new Array(n.length), rl = new nu(), il = new nu(); ; )
      if (((u = ul), i && (!u || i.y < u.y || (i.y === u.y && i.x < u.x))))
        (i.x !== e || i.y !== r) &&
          ((el[i.i] = new Or(i)), jr(i), (e = i.x), (r = i.y)),
          (i = n.pop());
      else {
        if (!u) break;
        Ur(u.arc);
  ...
  function Pu(n) {
    ...
    t[0] * e[1] < e[0] * t[1] &&
      ((t[0] *= -1), (t[1] *= -1), (r *= -1), (u *= -1)),
      (this.rotate =
        (r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * Ha),
      (this.translate = [n.e, n.f]),
      (this.scale = [r, i]),
      (this.skew = i ? Math.atan2(u, i) * Ha : 0);
  }
  function Uu(n, t) {
    return n[0] * t[0] + n[1] * t[1];
  }
  ...
  function Wi(n, t) {
    var e = Bi(t[2]);
    return n in _l
      ? Math.abs(e - Bi(Math.max(va(t[0]), va(t[1])))) + +("e" !== n)
      : e - 2 * ("%" === n);
  }
  function Ji(n, t, e, r) {
    function u(n) {
  ...
  function ho(n) {
    function t(t) {
      ...
      for (
        var c, l = [], s = [], f = -1, h = t.length, g = kt(e), p = kt(r);
        ++f < h;
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((o = "function" == typeof n ? (i = n) : (i = zl.get(n) || go).key),
            t)
          : o;
      }),
  ...
  function Do(n) {
    ...
    return (
      ...
      (t.interpolate = function (n) {
        return arguments.length
          ? ((c = "function" == typeof n ? (a = n) : (a = zl.get(n) || go).key),
            (l = a.reverse || a),
            (s = a.closed ? "M" : "L"),
            t)
          : c;
  ...
  (ta.ascending = n),
    ...
    (ta.sum = function (n, t) {
      var r,
        ...
        i = n.length,
        o = -1;
      if (1 === arguments.length) for (; ++o < i; ) e((r = +n[o])) && (u += r);
      else for (; ++o < i; ) e((r = +t.call(n, n[o], o))) && (u += r);
      return u;
    }),
    (ta.mean = function (n, r) {
      ...
      else for (; ++a < o; ) e((u = t(r.call(n, n[a], a)))) ? (i += u) : --c;
      return c ? i / c : void 0;
    }),
    ...
    (ta.median = function (r, u) {
      ...
      else for (; ++c < a; ) e((i = t(u.call(r, r[c], c)))) && o.push(i);
      return o.length ? ta.quantile(o.sort(n), 0.5) : void 0;
    }),
  ...
  var pa = r(n);
  (ta.bisectLeft = pa.left),
    (ta.bisect = ta.bisectRight = pa.right),
    (ta.bisector = function (t) {
      return r(
        1 === t.length
          ? function (e, r) {
              return n(t(e), r);
  ...
  (ta.range = function (n, t, e) {
    ...
    var r,
      ...
      a = -1;
    if (((n *= o), (t *= o), (e *= o), 0 > e))
      for (; (r = n + e * ++a) > t; ) u.push(r / o);
    else for (; (r = n + e * ++a) < t; ) u.push(r / o);
    return u;
  }),
    (ta.map = function (n, t) {
      var e = new a();
  ...
  o(a, {
    ...
    (ta.nest = function () {
      function n(t, o, c) {
        ...
        for (
          var l, s, f, h, g = -1, p = o.length, v = i[c++], d = new a();
          ++g < p;
  ...
  (ta.dispatch = function () {
    for (var n = new M(), t = -1, e = arguments.length; ++t < e; )
      n[arguments[t]] = x(n);
    return n;
  }),
  ...
  (ta.ns = {
    ...
    qualify: function (n) {
      ...
      return (
        ...
        Ea.hasOwnProperty(e) ? { space: Ea[e], local: n } : n
      );
    },
  }),
  ...
  var Aa = [];
  (ta.selection.enter = O),
    (ta.selection.enter.prototype = Aa),
    (Aa.append = ka.append),
    (Aa.empty = ka.empty),
    (Aa.node = ka.node),
    (Aa.call = ka.call),
      ...
      function t(n, t, u, i, o) {
        return function () {
          ...
          var l,
            ...
            M = t(h, v);
          r
            ? ((l = r.apply(s, arguments)), (l = [l.x - M[0], l.y - M[1]]))
            : (l = [0, 0]),
            g({ type: "dragstart" });
        };
      }
    ...
    (ta.behavior.zoom = function () {
      ...
      function f() {
        ...
        function e() {
          ...
          for (var e = ta.event.changedTouches, r = 0, u = e.length; u > r; ++r)
      ...
      function h() {
        ...
        m
          ? clearTimeout(m)
          : ((p = t((v = d || ta.mouse(this)))), Fl.call(this), a(n)),
          (m = setTimeout(function () {
            (m = null), l(n);
          }, 50)),
          b(),
          r(Math.pow(2, 0.002 * Za()) * k.k),
          u(v, p),
          c(n);
      }
      function g() {
        ...
        i(
          ...
          n,
          t(n),
          ta.event.shiftKey ? Math.ceil(e) - 1 : Math.floor(e) + 1
        );
      }
      var p,
        v,
      ...
      return (
        ...
        (n.scale = function (t) {
          return arguments.length
            ? ((k = { x: k.x, y: k.y, k: +t }), o(), n)
            : k.k;
        }),
        (n.scaleExtent = function (t) {
          return arguments.length
            ? ((A = null == t ? Va : [+t[0], +t[1]]), n)
            : A;
        }),
        (n.center = function (t) {
        ...
        (n.x = function (t) {
          return arguments.length
            ? ((x = t), (M = t.copy()), (k = { x: 0, y: 0, k: 1 }), n)
            : x;
        }),
        (n.y = function (t) {
          return arguments.length
            ? ((S = t), (_ = t.copy()), (k = { x: 0, y: 0, k: 1 }), n)
            : S;
        }),
        ta.rebind(n, R, "on")
      );
  ...
  (Ba.brighter = function (n) {
    return new ct(
      this.h,
      this.c,
      Math.min(100, this.l + Wa * (arguments.length ? n : 1))
    );
  }),
    (Ba.darker = function (n) {
      return new ct(
        this.h,
        this.c,
        Math.max(0, this.l - Wa * (arguments.length ? n : 1))
      );
    }),
    (Ba.rgb = function () {
  ...
  (ta.timer = function (n, t, e) {
    ...
    rc ? (rc.n = i) : (ec = i),
      (rc = i),
      uc || ((ic = clearTimeout(ic)), (uc = 1), ac(qt));
  }),
  ...
  (fc.year = Ft(
    ...
    (fc.years = fc.year.range),
    (fc.years.utc = fc.year.utc.range),
    (fc.day = Ft(
      function (n) {
        var t = new hc(2e3, 0);
    ...
    (fc.days = fc.day.range),
    (fc.days.utc = fc.day.utc.range),
    (fc.dayOfYear = function (n) {
      var t = fc.year(n);
      return Math.floor(
    ...
    [
      ...
      var e = (fc[n] = Ft(
        function (n) {
          return (
            (n = fc.day(n)).setDate(n.getDate() - ((n.getDay() + t) % 7)), n
          );
        },
        function (n, t) {
      ...
      (fc[n + "s"] = e.range),
        (fc[n + "s"].utc = e.utc.range),
        (fc[n + "OfYear"] = function (n) {
          var e = fc.year(n).getDay();
          return Math.floor((fc.dayOfYear(n) + ((e + t) % 7)) / 7);
        });
    }),
    (fc.week = fc.sunday),
    (fc.weeks = fc.sunday.range),
    (fc.weeks.utc = fc.sunday.utc.range),
    (fc.weekOfYear = fc.sundayOfYear);
  var pc = { "-": "", _: " ", 0: "0" },
    vc = /^\s*\d+/,
    dc = /^%/;
  ...
  (ta.format = mc.numberFormat),
    ...
    (ce.prototype = {
      ...
      add: function (n) {
        le(n, this.t, yc),
          le(yc.s, this.s, this),
          this.s ? (this.t += yc.t) : (this.s = yc.t);
      },
      reset: function () {
        this.s = this.t = 0;
      },
  ...
  var bc,
    ...
    wc = {
      ...
      polygonEnd: function () {
        var n = 2 * _c;
        (bc += 0 > n ? 4 * Da + n : n),
          (wc.lineStart = wc.lineEnd = wc.point = y);
      },
    };
  (ta.geo.bounds = (function () {
    ...
    (ta.geo.centroid = function (n) {
      (Sc = kc = Ec = Ac = Nc = Cc = zc = qc = Lc = Tc = Rc = 0),
        ta.geo.stream(n, Dc);
      var t = Lc,
        e = Tc,
        r = Rc,
      ...
      return Ra > u &&
        ...
        (e = zc),
        (r = qc),
        Ta > kc && ((t = Ec), (e = Ac), (r = Nc)),
        (u = t * t + e * e + r * r),
        Ra > u)
        ? [0 / 0, 0 / 0]
        : [Math.atan2(e, t) * Ha, nt(r / Math.sqrt(u)) * Ha];
    });
  var Sc,
    kc,
    Ec,
        ...
        (n.translate = function (t) {
          ...
          return (
            ...
            (r = o
              ...
              .clipExtent([
                [s - 0.425 * l + Ta, f + 0.12 * l + Ta],
                [s - 0.214 * l - Ta, f + 0.234 * l - Ta],
              ])
              .stream(c).point),
            (u = a
              .translate([s - 0.205 * l, f + 0.212 * l])
              .clipExtent([
                [s - 0.214 * l + Ta, f + 0.166 * l + Ta],
                [s - 0.115 * l - Ta, f + 0.234 * l - Ta],
              ])
              .stream(c).point),
            n
          );
  ...
  (ta.geo.path = function () {
    ...
    return (
      ...
      (n.centroid = function (n) {
        return (
          (Ec = Ac = Nc = Cc = zc = qc = Lc = Tc = Rc = 0),
          ta.geo.stream(n, u(Xc)),
          Rc
            ? [Lc / Rc, Tc / Rc]
            : qc
            ? [Cc / qc, zc / qc]
    ...
    (ta.geo.rotation = function (n) {
      ...
      return (
        (n = lr((n[0] % 360) * Fa, n[1] * Fa, n.length > 2 ? n[2] * Fa : 0)),
        (t.invert = function (t) {
          return (
            (t = n.invert(t[0] * Fa, t[1] * Fa)), (t[0] *= Ha), (t[1] *= Ha), t
          );
        }),
        t
      );
          ...
          if (!isNaN(e) && !isNaN(r))
            if (n.leaf) {
              var c = n.x,
                s = n.y;
              if (null != c)
                if (va(c - e) + va(s - r) < 0.01) l(n, t, e, r, u, i, o, a);
                else {
                  var f = n.point;
  ...
  ta.layout.stack = function () {
    ...
    return (
      ...
      (n.order = function (t) {
        return arguments.length
          ? ((e = "function" == typeof t ? t : Ml.get(t) || ai), n)
          : e;
      }),
      (n.offset = function (t) {
        return arguments.length
          ? ((r = "function" == typeof t ? t : xl.get(t) || ci), n)
          : r;
      }),
      (n.x = function (t) {
        return arguments.length ? ((i = t), n) : i;
      ...
      function n() {
        ...
        if (
          ((m = (+c.apply(this, arguments) || 0) / 2) &&
            ((d =
              i === Cl ? Math.sqrt(n * n + l * l) : +i.apply(this, arguments)),
            g || (A *= -1),
            l && (A = nt((d / l) * Math.sin(m))),
            n && (E = nt((d / n) * Math.sin(m)))),
          l)
        ) {
          (y = l * Math.cos(s + A)),
            (M = l * Math.sin(s + A)),
          ...
          if (null != x) {
            ...
            p === H
              ? N.push(
                  ...
                  l,
                  " 0 ",
                  (1 - g) ^ so(O[1][0], O[1][1], Y[1][0], Y[1][1]),
                  ",",
                  g,
                  " ",
                  Y[1],
      ...
      return (
        ...
        (n.centroid = function () {
          var n = (+e.apply(this, arguments) + +r.apply(this, arguments)) / 2,
            t =
              (+o.apply(this, arguments) + +a.apply(this, arguments)) / 2 - ja;
  ...
  (ka.transition = function (n) {
    for (
      var t,
        ...
        u = Xo(n),
        i = [],
        o = jl || { time: Date.now(), ease: Su, delay: 0, duration: 250 },
        a = -1,
        c = this.length;
      ++a < c;
  ...
  (Hl.call = ka.call),
    ...
    (ta.transition.prototype = Hl),
    (Hl.select = function (n) {
      var t,
        e,
        r,
        u = this.id,
    ...
    (Hl.styleTween = function (n, t, e) {
      function r(r, u) {
        var i = t.call(
          ...
          r,
          u,
          oa.getComputedStyle(this, null).getPropertyValue(n)
        );
        return (
          i &&
          function (t) {
          ...
          if (
            ("bottom" === r || "top" === r
              ? ((n = Bo),
                ...
                (w = "x2"),
                (k = "y2"),
                N.attr("dy", 0 > q ? "0em" : ".71em").style(
                  "text-anchor",
                  "middle"
                ),
                b.attr(
                  "d",
                  "M" + M[0] + "," + q * i + "V0H" + M[1] + "V" + q * i
                ))
              : ((n = Wo),
                (_ = "y"),
                (S = "x"),
                (w = "y2"),
                (k = "x2"),
                N.attr("dy", ".32em").style(
                  "text-anchor",
                  0 > q ? "end" : "start"
                ),
                b.attr(
                  "d",
                  "M" + q * i + "," + M[0] + "H0V" + M[1] + "H" + q * i
                )),
            E.attr(k, q * u),
            C.attr(S, q * y),
            A.attr(w, 0).attr(k, q * u),
            z.attr(_, 0).attr(S, q * y),
            f.rangeBand)
          ) {
            var L = f,
              T = L.rangeBand() / 2;
  ...
  var Yl = "bottom",
    Il = { top: 1, right: 1, bottom: 1, left: 1 };
  ta.svg.brush = function () {
    function n(i) {
      i.each(function () {
        ...
        var s,
          f = ta.transition(i),
          h = ta.transition(o);
        c && ((s = Ui(c)), h.attr("x", s[0]).attr("width", s[1] - s[0]), e(f)),
          l &&
            ((s = Ui(l)), h.attr("y", s[0]).attr("height", s[1] - s[0]), r(f)),
          t(f);
      });
    }
    function t(n) {
    ...
    function u() {
      function u() {
        32 == ta.event.keyCode &&
          (N || ((y = null), (z[0] -= s[1]), (z[1] -= f[1]), (N = 2)), b());
      }
      function p() {
        32 == ta.event.keyCode &&
          2 == N &&
          ((z[0] += s[1]), (z[1] += f[1]), (N = 0), b());
      }
      function v() {
        var n = ta.mouse(x),
          u = !1;
        M && ((n[0] += M[0]), (n[1] += M[1])),
          N ||
            (ta.event.altKey
              ? (y || (y = [(s[0] + s[1]) / 2, (f[0] + f[1]) / 2]),
                (z[0] = s[+(n[0] < y[0])]),
                (z[1] = f[+(n[1] < y[1])]))
              : (y = null)),
          E && d(n, c, 0) && (e(S), (u = !0)),
          A && d(n, l, 1) && (r(S), (u = !0)),
          u && (t(S), w({ type: "brush", mode: N ? "move" : "resize" }));
      }
      function d(n, t, e) {
        var r,
          u,
        ...
        return (
          ...
          N
            ? (u = (r += p) + d)
            : (y && (p = Math.max(c, Math.min(l, 2 * y[e] - r))),
              r > p ? ((u = r), (r = p)) : (u = p)),
          v[0] != r || v[1] != u
  ...
  (Xl.iso =
    ...
    (fc.seconds = fc.second.range),
    (fc.seconds.utc = fc.second.utc.range),
    (fc.minute = Ft(
      function (n) {
    ...
    (fc.minutes = fc.minute.range),
    (fc.minutes.utc = fc.minute.utc.range),
    (fc.hour = Ft(
      function (n) {
    ...
    (fc.hours = fc.hour.range),
    (fc.hours.utc = fc.hour.utc.range),
    (fc.month = Ft(
      function (n) {
    ...
    (fc.months = fc.month.range),
    (fc.months.utc = fc.month.utc.range);
  var Wl = [
